...
class TestOrderService(unittest.TestCase):
    def setUp(self):
        ...
        self.inserted_customer = Customer(id=0, first_name = "Jane", last_name="Doe", address = inserted_address, email = "janedoe@gmail.com")
        self.inserted_account = Account(id=0, account_number=0, customer=inserted_customer, current_balance=25)
